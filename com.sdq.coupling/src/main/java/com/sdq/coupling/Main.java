...
public class Main {
	public static void run(String modelDirectoryPath, String jarFilePath) {
		...
		AbstractPropertyViolationMapping ppm = new CarismaCognicryptMapping(); // already maps common errors to common properties internally
		...
		apm.removeProperties("./example.uml", vp);

...
/***
 * Defines interface to extract and remove architecture security properties from model files.
 * @author Laura
 *
 */
public interface IArchitecturePropertyManager {
	...
	/***
	 * Feeds back the violated properties into the architecture model by deleting them.
	 * @param modelDirectoryPath 	Path to model file directory.
	 * @param violatedProperties 	List of violated properties to be deleted.
	 */
	void removeProperties(String modelDirectoryPath, List<AbstractArchitectureProperty> violatedProperties);
}

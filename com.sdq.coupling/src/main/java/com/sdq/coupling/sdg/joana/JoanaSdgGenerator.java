...
public class JoanaSdgGenerator implements ISdgGenerator {
	...
	public Graph<AbstractSdgVertex, AbstractSdgEdge> generate(String jarFilePath) {
		...
		try {
			// "C:\Program Files\Eclipse Adoptium\jdk-8.0.345.1-hotspot\bin\java.exe" -jar "C:\Users\laura\Downloads\com.sdq.coupling (2)\com.sdq.coupling\src\main\resources\joana.ui.ifc.wala.cli.jar" "classPath C:\\Users\\laura\\Downloads\\test4.jar" "entry select coupling" "buildSDG" "exportSDG sdg.pdg.graphml"
			
			
			ProcessBuilder pb = new ProcessBuilder(
					"\"C:\\Program Files\\Eclipse Adoptium\\jdk-8.0.345.1-hotspot\\bin\\java.exe\"",
					"-jar",
					".\\src\\main\\resources\\joana.ui.ifc.wala.cli.jar",
					"\"classPath "+ jarFilePath + "\"",
					"\"entry select coupling\"",
					"\"buildSDG\"",
					"\"exportSDG ./src/main/resources/tmp/sdg.pdg.graphml\""
			);
		...
		GraphMLImporter<AbstractSdgVertex, AbstractSdgEdge> gml = new GraphMLImporter<AbstractSdgVertex, AbstractSdgEdge>();
		...
		Graph<AbstractSdgVertex, AbstractSdgEdge> graph = new DirectedPseudograph<AbstractSdgVertex, AbstractSdgEdge>(
				new JoanaSdgVertexSupplier(), 
				new JoanaSdgEdgeSupplier(), false);
